$(document).ready(function() {
    $('#submitRecipeForm').submit(function(event) {
        ...
        const apiUrl = 'https://8gujhwbyd0.execute-api.us-east-1.amazonaws.com/dev/submit-recipe';
    ...
    function updateRecipesPage() {
        $.ajax({
            url: 'https://gmbe2anqbl.execute-api.us-east-1.amazonaws.com/dev/submit-recipe/{id}',
            type: 'GET',
